...
rm -f "$COMMANDS_DIR/statusline-compaction.md"
rm -f "$COMMANDS_DIR/statusline-git-diff-stats.md"
rm -f "$COMMANDS_DIR/statusline-pr.md"
rm -f "$COMMANDS_DIR/statusline-worktree.md"
rm -f "$COMMANDS_DIR/statusline-conflicts.md"
rm -f "$COMMANDS_DIR/statusline-output-style.md"
rm -f "$COMMANDS_DIR/statusline-session-id.md"
rm -f "$COMMANDS_DIR/statusline-version.md"
rm -f "$COMMANDS_DIR/statusline-cwd.md"
rm -f "$COMMANDS_DIR/statusline-extra-usage.md"
...
rm -rf "$CLAUDE_DIR/.statusline-state"
